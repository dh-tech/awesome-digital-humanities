...
- [palimpsest](https://github.com/jQuinRivero/palimpsest) - Typography-first collation reader for comparing two versions of a literary text. Reports word-level variants and detects moved, split, and merged passages separately, compares verse line by line, and exports TEI P5 using parallel segmentation.
