...
- [Stellar](https://github.com/toutoutoubun/stellar) - Free, offline-first research environment for humanities scholars. Features a library manager, Markdown editor with WikiLinks and @cite syntax, bidirectional knowledge graph, qualitative coding, citation network visualization, and export to PDF/DOCX/HTML. Runs locally on SQLite with no cloud dependency. MIT license.
