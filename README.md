...
- [Odù Core](https://github.com/timeyinallout-cloud/odu-core) - Python and TypeScript library encoding the 256 Odù of Ifá divination as a canonical byte mapping with Yorùbá orthography preserved. All 16 principal figures are verified against Bascom (1969) and cited by page, so the encoding is traceable to the ethnographic source rather than asserted.
