...
- [Histoda](https://github.com/makosai/histoda) - A versatile web application for exploring, correlating, and analyzing multi-decade and multi-century historical datasets including climate records, seismic activity, and human conflicts.
